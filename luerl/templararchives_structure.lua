-- The Templar Archives allows the Protoss to produce High Templars and Dark Templars from the Gateway.
-- In addition, allow the unlocking of level 2 and 3 ground weapon and armor at the Forge.
