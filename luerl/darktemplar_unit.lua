-- The Dark Templar, commonly abbreviated as DT, is a permanently cloaked Protoss ground unit. 
-- It is built from the Gateway if there is an existing Templar Archives
