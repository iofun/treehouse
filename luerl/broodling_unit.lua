-- The Broodling is a small Zerg unit spawned when a Queen casts Spawn Broodling on a target. 
-- Two Broodlings spawn per spell cast. Upon their creation, they have a fixed amount of "energy" that represents their life span. 
